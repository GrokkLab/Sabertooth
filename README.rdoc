...
3. create login role 10AnC in postgres
...
10AnC works just fine as a single tenant app, but maybe you need to support 2 or 3 or eleventeen
different organizations. No problem.  10AnC comes with some easy-peasy rake tools to do just that.

Spose your new tenant is named 'acme', then...
  rake schema:reset TENANT_NAME=acme
